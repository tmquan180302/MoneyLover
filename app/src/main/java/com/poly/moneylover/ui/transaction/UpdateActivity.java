...
public class UpdateActivity extends AppCompatActivity implements ItemOnclick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            long result = Long.parseLong(expenseItem.getExpenseItem().getPrice());
            String formattedString = Convert.FormatNumber(result);
            binding.edtMoney.setText(formattedString);
            binding.edtMoney.setSelection(formattedString.length());
