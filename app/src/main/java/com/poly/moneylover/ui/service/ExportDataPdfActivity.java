...
public class ExportDataPdfActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_export_data_pdf);
        initView();
        back();
        export();
        download();
        ...
        if (ActivityCompat.checkSelfPermission(this, PERMISSION_WRITE_EXTERNAL_STORAGE)
            ...
            builder.setMessage("This app requires WRITE_EXTERNAL_STORAGE permission ")
                    ...
                    .setPositiveButton("Ok", (dialog, which) -> {
                        ActivityCompat.requestPermissions(ExportDataPdfActivity.this, new String[]{PERMISSION_WRITE_EXTERNAL_STORAGE},
                                PERMISSION_REQ_CODE);
                        dialog.dismiss();
                    })
    ...
    private void export() {
        ...
        Thread thread = new Thread(() -> {
            try {
                Response<Export> call = BudgetApi.api.getLinkPdf().execute();
